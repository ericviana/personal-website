    ...
    <div className="bg-white text-zinc-900 antialiased">
      <div className="max-w-xl mx-auto my-[30vh] px-6">
        ...
        <div className="flex gap-2 mt-7">
          ...
          <a href="https://blog.fros.dev" className="bg-zinc-900/90 text-xs text-neutral-50 shadow-lg hover:shadow-xl transition-all rounded-lg w-fit px-3 py-1 border border-gray-600">📖 Articles</a>
